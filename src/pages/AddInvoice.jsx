    ...
    return (
        <div className="p-6 md:p-10 max-w-5xl mx-auto bg-gray-50 dark:bg-slate-950 min-h-screen transition-colors duration-300">
            <form onSubmit={handleSubmit} className="space-y-8 md:space-y-10">
                ...
                <section className="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-gray-200 dark:border-slate-800 p-8 md:p-10">
                    <div className="flex items-center justify-between mb-8 pb-3 border-b border-gray-100 dark:border-slate-800">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-y-8 gap-x-6">
                        <div>
                            <label className="block text-xs font-semibold text-gray-500 dark:text-slate-500 ml-1 mb-2">Invoice Number</label>
                            <input
                        ...
                        <div>
                            <label className="block text-xs font-semibold text-gray-500 dark:text-slate-500 ml-1 mb-2">Invoice Date</label>
                            <input
                        ...
                        <div>
                            <label className="block text-xs font-semibold text-gray-500 dark:text-slate-500 ml-1 mb-2">Due Date</label>
                            <input
                        ...
                        <div>
                            <label className="block text-xs font-semibold text-gray-500 dark:text-slate-500 ml-1 mb-2">Payment Terms</label>
                            <input
                ...
                <section className="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-gray-200 dark:border-slate-800 p-8 md:p-10">
                    <div className="flex items-center gap-2 mb-8 pb-3 border-b border-gray-100 dark:border-slate-800">
                        <User size={18} className="text-blue-500" />
                        <h2 className="text-sm font-semibold text-gray-600 dark:text-slate-300">Company Information</h2>
                    </div>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-8 gap-x-6">
                        <div>
                            <label className="block text-xs font-semibold text-gray-500 dark:text-slate-500 ml-1 mb-2">Company Name</label>
                        ...
                        <div>
                            <label className="block text-xs font-semibold text-gray-500 dark:text-slate-500 ml-1 mb-2">State</label>
                            <div className="relative">
                ...
                <section className="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-gray-200 dark:border-slate-800 p-8 md:p-10">
                    ...
                    <div>
                        <label className="block text-xs font-semibold text-gray-500 dark:text-slate-500 ml-1 mb-2">Work Description</label>
                        <textarea
                            name="description" value={formData.description} onChange={handleChange}
                            className="w-full px-4 py-3 bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-xl text-gray-800 dark:text-slate-200 font-medium focus:ring-4 focus:ring-blue-100/50 dark:focus:ring-blue-900/20 focus:border-blue-500 outline-none transition-all resize-y h-24 hover:border-gray-300 dark:hover:border-slate-600 shadow-sm"
                ...
                <section className="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-gray-200 dark:border-slate-800 p-8 md:p-10">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-y-8 gap-x-6 mb-8">
                        <div>
                            <label className="block text-xs font-semibold text-gray-500 dark:text-slate-500 ml-1 mb-2">Price per Unit</label>
                            <input
                        ...
                        <div>
                            <label className="block text-xs font-semibold text-gray-500 dark:text-slate-500 ml-1 mb-2">Quantity</label>
                            <input
                ...
                <section className="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-gray-200 dark:border-slate-800 p-8 md:p-10">
                    ...
                    <div className="space-y-8">
                        ...
                        {formData.paymentStatus === 'PartiallyPaid' && (
                            <div className="animate-in fade-in slide-in-from-top-2 space-y-4 max-w-md">
                                <div>
                                    <label className="block text-xs font-semibold text-gray-500 dark:text-slate-500 ml-1 mb-2">Amount Received</label>
                                    <input
                                ...
                                <div className="p-4 bg-orange-50 dark:bg-orange-500/10 border border-orange-100 dark:border-orange-500/20 rounded-xl flex items-center justify-between mt-4">

...
const AddInvoice = () => {
    ...
    useEffect(() => {
        ...
        if (formData.paymentStatus === 'Paid') {
            balance = 0;
        } else if (formData.paymentStatus === 'PartiallyPaid') {
            balance = Math.max(0, total - (parseFloat(formData.paidAmount) || 0));
        }
                ...
                <form onSubmit={handleSubmit} className="p-6 md:p-8 space-y-8 md:y-10">
                    ...
                    <section className="bg-gray-50 dark:bg-slate-800/20 px-6 py-8 md:px-8 md:py-10 border-y border-gray-100 dark:border-slate-800">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-6 mb-8">
                            <div className="space-y-1.5">
                                <label className="text-xs font-semibold text-gray-500 dark:text-slate-500">Price per Unit (ex. GST)</label>
                                <input
